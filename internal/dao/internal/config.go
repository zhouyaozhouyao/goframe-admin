...
// ConfigDao is the data access object for table data_config.
...
// ConfigColumns defines and stores column names for table data_config.
...
// configColumns holds the columns for table data_config.
