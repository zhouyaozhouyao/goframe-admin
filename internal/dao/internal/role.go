...
// RoleDao is the data access object for table data_role.
type RoleDao struct {
...
// RoleColumns defines and stores column names for table data_role.
...
// roleColumns holds the columns for table data_role.
